...
# Setup
root = Tk()
root.title('Naveed \'s Speed Test')
...
def resetWritingLabels():
    ...
    global labelLeft
    labelLeft = Label(root, text=text[0:splitPoint], fg='black',bg="lightgreen")
...
def stopTest():
    ...
    global ResultLabel
    ResultLabel = Label(root, text=f'Words per Minute: {amountWords}', fg='black',bg="yellow")
